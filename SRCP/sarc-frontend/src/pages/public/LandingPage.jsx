                ...
                <section className="relative pt-32 pb-40 overflow-hidden bg-slate-900 border-b-4 border-secondary">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                            <Button variant="gradient" size="lg" className="shadow-lg shadow-primary/30">Explore Research Projects</Button>
                            <Button variant="secondary" size="lg" className="shadow-lg shadow-black/20 text-primary-dark">Join as Student / Faculty</Button>
                        </div>
                    </div>
                </section>
